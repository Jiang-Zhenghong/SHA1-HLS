 ...
 *
 */
void SHA1Input(SHA1Context *final_context, const unsigned char message_array[24])
{
	int i,k = 0;
    ...
    {
        context.Message_Block[context.Message_Block_Index++] = (message_array[k] & 0xFF);
    ...
    for (i = 0; i < 5; i++)
        final_context->Message_Digest[i] = context.Message_Digest[i];
}
